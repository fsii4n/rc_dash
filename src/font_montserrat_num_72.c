 ...
 * Size: 72 px
 * Bpp: 4
 * Opts: --font /tmp/Montserrat-Medium.ttf --size 72 --bpp 4 --format lvgl --range 0x2B-0x3A -o /Users/yutong/rc_dash/.claude/worktrees/agent-a7018a4181aace454/src/font_montserrat_num_72.c --force-fast-kern-format --no-compress
 ******************************************************************************/

#include <lvgl.h>

#ifndef FONT_MONTSERRAT_NUM_72
#define FONT_MONTSERRAT_NUM_72 1
#endif

#if FONT_MONTSERRAT_NUM_72
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xcc, 0xcc, 0xcc, 0xcc, 0xcc, 0xc0, 0x2f, 0xff,
    ...
    /* U+002C "," */
    0x0, 0x0, 0x45, 0x20, 0x0, 0x0, 0x7f, 0xff,
    0xfc, 0x20, 0x8, 0xff, 0xff, 0xff, 0xd1, 0x2f,
    0xff, 0xff, 0xff, 0xf8, 0x6f, 0xff, 0xff, 0xff,
    0xfd, 0x8f, 0xff, 0xff, 0xff, 0xfe, 0x6f, 0xff,
    0xff, 0xff, 0xfd, 0x2f, 0xff, 0xff, 0xff, 0xfb,
    0x9, 0xff, 0xff, 0xff, 0xf7, 0x0, 0x9f, 0xff,
    0xff, 0xf2, 0x0, 0xa, 0xff, 0xff, 0xd0, 0x0,
    0xd, 0xff, 0xff, 0x80, 0x0, 0x1f, 0xff, 0xff,
    0x20, 0x0, 0x5f, 0xff, 0xfd, 0x0, 0x0, 0x9f,
    0xff, 0xf8, 0x0, 0x0, 0xdf, 0xff, 0xf3, 0x0,
    0x1, 0xff, 0xff, 0xd0, 0x0, 0x5, 0xff, 0xff,
    0x80, 0x0, 0x9, 0xff, 0xff, 0x30, 0x0, 0xd,
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 670, .box_w = 34, .box_h = 32, .ofs_x = 4, .ofs_y = 10},
    {.bitmap_index = 544, .adv_w = 262, .box_w = 10, .box_h = 21, .ofs_x = 3, .ofs_y = -11},
    {.bitmap_index = 649, .adv_w = 441, .box_w = 20, .box_h = 7, .ofs_x = 4, .ofs_y = 17},
    {.bitmap_index = 719, .adv_w = 262, .box_w = 10, .box_h = 10, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 769, .adv_w = 406, .box_w = 32, .box_h = 69, .ofs_x = -3, .ofs_y = -7},
    {.bitmap_index = 1873, .adv_w = 768, .box_w = 42, .box_h = 53, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 2986, .adv_w = 426, .box_w = 20, .box_h = 51, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3496, .adv_w = 661, .box_w = 38, .box_h = 52, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4484, .adv_w = 659, .box_w = 38, .box_h = 52, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 5472, .adv_w = 771, .box_w = 46, .box_h = 51, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 6645, .adv_w = 661, .box_w = 38, .box_h = 52, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 7633, .adv_w = 711, .box_w = 40, .box_h = 53, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 8693, .adv_w = 689, .box_w = 39, .box_h = 51, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 9688, .adv_w = 742, .box_w = 41, .box_h = 53, .ofs_x = 3, .ofs_y = -1},
    {.bitmap_index = 10775, .adv_w = 711, .box_w = 39, .box_h = 53, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 11809, .adv_w = 262, .box_w = 10, .box_h = 39, .ofs_x = 3, .ofs_y = 0}
};
...
static const int8_t kern_class_values[] =
{
    3, -8, 0, 8, -21, -15, -23, 8,
    0, -12, 0, 0, 0, -8, 0, 114,
    -14, -15, 12, 12, -10, 0, -15, 12,
    0, 0, -78, -112, -78, -23, 35, 0,
    0, -77, 0, 14, -26, 0, -17, 8,
    -14, -23, 0, -3, -3, -12, 0, 0,
    -8, 0, 0, 0, -8, 12, 12, -3,
    0, 0, 0, -22, 0, -3, 0, 0,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_montserrat_num_72 = {
#else
lv_font_t font_montserrat_num_72 = {
#endif
...
#endif /*#if FONT_MONTSERRAT_NUM_72*/
